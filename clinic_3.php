...
<?php include('navbar_dasboard.php'); ?>
	...
	/* 	echo $count; */
		...
		?>
		<div class="question">
		<div class="alert alert-success">رقم الموعد <strong><?php echo $equal; ?></strong> المريض على تاريخ<strong><?php echo  $date; ?></strong></div>
    ...
    <div class="control-group">
    <label class="control-label" for="inputPassword">الخدمة</label>
    <div class="controls">
