...
<?php include('navbar_dasboard.php'); ?>
			...
			<div class="row">
				...
				<div class="span3">
					    <ul class="nav nav-tabs nav-stacked">
							<li class="active">
							<a href="#"><i class="icon-pencil icon-large"></i>&nbsp;انشاء حساب</a>
							</li>
				...
				<a href="dasboard.php">
    <img src="back.jpg" alt="Description of the image">
</a>
				...
				<div class="alert alert-info">أختر تاريخ معاينتك و نوعالمعالجة</div>
	...
	/* 	echo $count; */
		...
		?>
		<div class="question">
		<div class="alert alert-success">رقم الموعد <strong><?php echo $equal; ?></strong> المريض على الموعد <strong><?php echo  $date; ?></strong></div>
		...
		<p>اضغط للموافقة على هذا الموعد</p>
    ...
    <form method="POST" action="chat.php?member_id=<?php echo $member_id; ?>">
    ...
    <a href="view_members.php">Back to Members</a>
				...
				<img src="img/32x32/rss.png">
				    <ul class="nav nav-list">
					 <div class="alert alert-danger"><li class="nav-header">ملاحضة</li></div>
				...
				<div class="alert alert-info">الخدمات</div>
						<table class="table  table-bordered">
								...
								<?php $user_query=mysqli_query($conn,"select * from service where user_id='9'")or die(mysqli_error($conn));
