      ...
      <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
					...
					<li><a rel="tooltip"  data-placement="bottom" title="About Us" id="aboutus" href="about.php" class=""><i class="icon-info icon-large"></i>&nbsp;حول</a></li>
					<li  class="active"><a rel="tooltip"  data-placement="bottom" title="Contact Us" id="contactus" href="contact_us.php" class=""><i class="icon-phone icon-large"></i>&nbsp;للأتصال بنا</a></li>
	 ...
	 <div class="contact-info">
        ...
        <div class="contact-item">
            ...
            <span>العنوان: شارع المثال، مدينة المثال</span>
				...
				<div class="span12">
				<div class="caption_index">صحتك تبدا من فمك</div>
				</div>		
